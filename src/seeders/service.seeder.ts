    ...
    await serviceModel.create([
        {
          ...
          details:
            'Our trained Buddies are empathetic listeners here to support you in a friendly, casual conversation. No advice, no fixing — just presence and compassion.',
        ...
        },
        {
          ...
          details:
            'Our Mentors help you navigate specific challenges — like stress, purpose, relationships, or goals — with personal development tools and practical insights.',
        ...
        },
        {
          ...
          details:
            'Licensed psychologists and trained mental health experts to support deeper issues like anxiety, depression, trauma, grief, or emotional regulation.',
